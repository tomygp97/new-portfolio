...
export const technologies = [
    {
        name: 'Golang',
        icon: (
            <Image src="/golang-svgrepo-com.svg" alt="Golang Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Laravel',
        icon: (
            <Image src="/laravel-svgrepo-com.svg" alt="Laravel Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Php',
        icon: (
            <Image src="/php-svgrepo-com.svg" alt="Php Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Express.js',
        icon: (
            <Image src="/express-svgrepo-com.svg" alt="Express.js Logo" width={48} height={48} />
        ),
    },
    {
        name: 'MySQL',
        icon: (
            <Image src="/mysql-logo-svgrepo-com.svg" alt="MySQL Logo" width={48} height={48} />
        ),
    },
    {
        name: 'MongoDB',
        icon: (
            <Image src="/mongodb-svgrepo-com.svg" alt="MongoDB Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Next.js',
        icon: (
            <Image src="/nextjs-fill-svgrepo-com.svg" alt="Next.js Logo" width={48} height={48} />
        ),
    },
    {
        name: 'React',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 h-12 text-blue-400">
    ...
    },
    {
        name: 'TypeScript',
        icon: (
            <Image src="/typescript-official-svgrepo-com.svg" alt="Typescript Logo" width={48} height={48} />
        ),
    },
    {
        name: 'JavaScript',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-12 h-12 text-yellow-400">
    ...
    },
    {
        name: 'Redux',
        icon: (
            <Image src="/redux-svgrepo-com.svg" alt="Redux Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Node.js',
        icon: (
            <Image src="/node-js-svgrepo-com.svg" alt="Node.js Logo" width={48} height={48} />
        ),
    },
    {
        name: 'AWS',
        icon: (
            <Image src="/aws-svgrepo-com.svg" alt="aws Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Firebase',
        icon: (
            <Image src="/firebase-svgrepo-com.svg" alt="Firebase Logo" width={48} height={48} />
        ),
    },
    {
        name: 'Postman',
  ...
  // Add more technologies with their respective SVG icons
]
